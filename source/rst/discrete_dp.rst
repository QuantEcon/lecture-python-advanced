...
* See `this discussion <https://python-intro.quantecon.org/finite_markov.html#Computing-Expectations>`__ on computing expectations of Markov chains for an explanation of the expression in :eq:`ddp_expec`.
