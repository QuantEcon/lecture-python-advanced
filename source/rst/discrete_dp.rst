...
Notice that :math:`Q_\sigma` is a `stochastic matrix <https://python-intro.quantecon.org/finite_markov.html#finite_dp_stoch_mat>`__ on :math:`S`.
...
* See `this discussion <https://python-intro.quantecon.org/finite_markov.html#finite_mc_expec>`__ on computing expectations of Markov chains for an explanation of the expression in :eq:`ddp_expec`.
